...
#define max_size_log_array 500 // 500 moves maximum should be well enough for a game (could be raised if needed), we can cut more the log if we want to save memory
...
extern const move start_square_mask;
extern const move target_square_mask;
extern const move flag_mask;
...
extern const int Castle_Flag;
extern const int Pawn_Two_Up_Flag;
extern const int Promote_To_Queen_Flag;
extern const int Promote_To_Knight_Flag;
extern const int Promote_To_Rook_Flag;
extern const int Promote_To_Bishop_Flag;
// Castling rights flags (declaration but no initialization)
extern const castling_rights_flags White_King_Moved_Flag;
extern const castling_rights_flags White_Rook_A_Moved_Flag;
extern const castling_rights_flags White_Rook_H_Moved_Flag;
extern const castling_rights_flags Black_King_Moved_Flag;
extern const castling_rights_flags Black_Rook_A_Moved_Flag;
extern const castling_rights_flags Black_Rook_H_Moved_Flag;
